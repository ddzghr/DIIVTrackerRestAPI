after "production:users", :device_types do
  ...
  Device.create(name: 'Desktop',
                ...
                user_id: User.find_by_email('ivor.andelkovic@racunarstvo.hr').id,
  ...
  Device.create(name: 'KurirWEB',
                ...
                user_id: User.find_by_email('opacak.ivan@racunarstvo.hr').id,
